...
("file-gif-save",
  ...
  (
    ...
    (
      "uri",
      "GIMP_PDB_STRING",
      "The name of the URI to export the image in",
    ),
    (
      "raw-uri",
      "GIMP_PDB_STRING",
...
("file-heif-save",
  ...
  (
    ...
    (
      "uri",
      "GIMP_PDB_STRING",
      "The URI of the file to export the image to",
    ),
    (
      "raw-uri",
      "GIMP_PDB_STRING",
      "The UTI of the file to export the image to",
    ),
    (
      "quality",
      "GIMP_PDB_INT32",
      "Quality factor (range: 0-100. 0 = worst, 100 = best)",
    ),
    (
      "lossless",
      "GIMP_PDB_INT32",
      "Use lossless compression (0 = lossy, 1 = lossless)",
    ),
  ),
  (
  ),
...
("file-pcx-save",
  ...
  (
    ...
    (
      "filename",
      "GIMP_PDB_STRING",
      "The name of the file to export the image in",
    ),
    (
      "raw-filename",
      "GIMP_PDB_STRING",
...
("plug-in-lighting",
  ...
  (
    ...
    (
      "highlight",
      "GIMP_PDB_FLOAT",
      "Material highlight (0..->), note: it's exponential",
    ),
    (
      "antialiasing",
      "GIMP_PDB_INT32",
...
("gimp-image-scale-full",
  ...
  (
    ...
    (
      "interpolation",
      "GIMP_PDB_INT32",
      "Type of interpolation @{ INTERPOLATION-NONE (0), INTERPOLATION-LINEAR (1), INTERPOLATION-CUBIC (2), INTERPOLATION-NOHALO (3), INTERPOLATION-LOHALO (4) @}",
    ),
  ),
  (
  ),
...
("gimp-image-new-with-precision",
  ...
  (
    ...
    (
      "precision",
      "GIMP_PDB_INT32",
      "The precision @{ PRECISION-U8-LINEAR (100), PRECISION-U8-GAMMA (150), PRECISION-U16-LINEAR (200), PRECISION-U16-GAMMA (250), PRECISION-U32-LINEAR (300), PRECISION-U32-GAMMA (350), PRECISION-HALF-LINEAR (500), PRECISION-HALF-GAMMA (550), PRECISION-FLOAT-LINEAR (600), PRECISION-FLOAT-GAMMA (650), PRECISION-DOUBLE-LINEAR (700), PRECISION-DOUBLE-GAMMA (750) @}",
    ),
  ),
  (
    (
...
("gimp-drawable-brightness-contrast",
  ...
  (
    ...
    (
      "brightness",
      "GIMP_PDB_FLOAT",
      "Brightness adjustment (-0.5 <= brightness <= 0.5)",
    ),
    (
      "contrast",
      "GIMP_PDB_FLOAT",
      "Contrast adjustment (-0.5 <= contrast <= 0.5)",
    ),
  ),
  (
  ),
...
("gimp-by-color-select-full",
  ...
  (
    ...
    (
      "select-criterion",
      "GIMP_PDB_INT32",
      "The criterion used to determine color similarity. SELECT_CRITERION_COMPOSITE is the standard choice. @{ SELECT-CRITERION-COMPOSITE (0), SELECT-CRITERION-R (1), SELECT-CRITERION-G (2), SELECT-CRITERION-B (3), SELECT-CRITERION-H (4), SELECT-CRITERION-S (5), SELECT-CRITERION-V (6), SELECT-CRITERION-A (7), SELECT-CRITERION-LCH-L (8), SELECT-CRITERION-LCH-C (9), SELECT-CRITERION-LCH-H (10) @}",
    ),
  ),
  (
  ),
...
("file-raw-set-defaults",
  ...
  (
    ...
    (
      "palette-type",
      "GIMP_PDB_INT32",
      "The palette type @{ RAW_PALETTE_RGB (0), RAW_PALETTE_BGR (1) @}",
    ),
  ),
  (
  ),
...
("gimp-drawable-transform-shear",
  ...
  (
    ...
    (
      "supersample",
      "GIMP_PDB_INT32",
      "This parameter is ignored (TRUE or FALSE)",
    ),
    (
      "recursion-level",
      "GIMP_PDB_INT32",
      "This parameter is ignored (recursion-level >= 1)",
    ),
    (
      "clip-result",
      "GIMP_PDB_INT32",
...
("gimp-image-convert-precision",
  ...
  (
    ...
    (
      "precision",
      "GIMP_PDB_INT32",
      "The new precision @{ PRECISION-U8-LINEAR (100), PRECISION-U8-GAMMA (150), PRECISION-U16-LINEAR (200), PRECISION-U16-GAMMA (250), PRECISION-U32-LINEAR (300), PRECISION-U32-GAMMA (350), PRECISION-HALF-LINEAR (500), PRECISION-HALF-GAMMA (550), PRECISION-FLOAT-LINEAR (600), PRECISION-FLOAT-GAMMA (650), PRECISION-DOUBLE-LINEAR (700), PRECISION-DOUBLE-GAMMA (750) @}",
    ),
  ),
  (
  ),
...
("file-j2k-load",
  ...
  (
    ...
    (
      "colorspace",
      "GIMP_PDB_INT32",
      "Color space @{ UNKNOWN (0), GRAYSCALE (1), RGB (2), CMYK (3), YCbCr (4), xvYCC (5) @}",
    ),
  ),
  (
    (
...
("plug-in-spyrogimp",
  ...
  (
    ...
    (
      "hole-percent",
      "GIMP_PDB_FLOAT",
      "Location of hole in moving gear in percent, where 100 means that the hole is at the edge of the gear, and 0 means the hole is at the center",
    ),
    (
      "margin",
      "GIMP_PDB_INT32",
    ...
    (
      "long-gradient",
      "GIMP_PDB_INT32",
      "Whether to apply a long gradient to match the length of the pattern (TRUE or FALSE). Only applicable to some of the tools.",
    ),
  ),
  (
  ),
...
("plug-in-screenshot",
  ...
  (
    ...
    (
      "window-id",
      "GIMP_PDB_INT32",
      "Window id for SHOOT-WINDOW",
    ),
    (
      "x1",
      "GIMP_PDB_INT32",
      "Region left x coord for SHOOT-REGION",
    ),
    (
      "y1",
      "GIMP_PDB_INT32",
      "Region top y coord for SHOOT-REGION",
    ),
    (
      "x2",
      "GIMP_PDB_INT32",
      "Region right x coord for SHOOT-REGION",
    ),
    (
      "y2",
      "GIMP_PDB_INT32",
      "Region bottom y coord for SHOOT-REGION",
    ),
  ),
  (
    (
...
("gimp-xcf-save",
  ...
  (
    ...
    (
      "filename",
      "GIMP_PDB_STRING",
      "The name of the file to save the image in, in URI format and UTF-8 encoding",
    ),
    (
      "raw-filename",
      "GIMP_PDB_STRING",
...
("gimp-plugin-precision-enabled",
  ...
  (
    (
      "enabled",
      "GIMP_PDB_INT32",
      "Whether precision is enabled (TRUE or FALSE)",
    ),
  ),
),
...
("file-gih-save",
  ...
  (
    ...
    (
      "uri",
      "GIMP_PDB_STRING",
      "The URI of the file to export the brush pipe in",
    ),
    (
      "raw-uri",
      "GIMP_PDB_STRING",
...
("plug-in-wavelet-decompose",
  ...
  (
    ...
    (
      "create-masks",
      "GIMP_PDB_INT32",
      "Add a layer mask to each scales layers",
    ),
  ),
  (
  ),
...
("gimp-context-get-transform-recursion",
  ...
  (
    (
      "transform-recursion",
      "GIMP_PDB_INT32",
      "This returns always 3 and is meaningless (transform-recursion >= 1)",
    ),
  ),
),
...
("python-fu-Ham-Gimp-Stable-diffusion-img2img",
  "",
  "Links to stable diffusion",
  "hamsolo474",
  "Licenced the same as Stable-Diffusion",
  "2022",
  "GIMP Plug-In",
  (
    (
    ...
    (
      "merged",
      "GIMP_PDB_INT32",
      "Merged (True) or Active layer (False)?",
    ),
    (
      "Pprompt",
      "GIMP_PDB_STRING",
...
("gimp-plugins-query",
  ...
  (
    (
      "num-plugins",
      "GIMP_PDB_INT32",
      "The number of plug-ins (num-plugins >= 0)",
    ),
    (
      "menu-path",
      "GIMP_PDB_STRINGARRAY",
...
("gimp-plugin-icon-register",
  ...
  (
    ...
    (
      "icon-type",
      "GIMP_PDB_INT32",
      "The type of the icon @{ ICON-TYPE-ICON-NAME (0), ICON-TYPE-INLINE-PIXBUF (1), ICON-TYPE-IMAGE-FILE (2) @}",
    ),
    (
      "icon-data-length",
      "GIMP_PDB_INT32",
...
("python-fu-Ham-Gimp-Stable-diffusion-txt2img",
  "",
  "Links to stable diffusion",
  "hamsolo474",
  "Licenced the same as Stable-Diffusion",
...
("gimp-image-convert-indexed",
  ...
  (
    ...
    (
      "palette-type",
      "GIMP_PDB_INT32",
      "The type of palette to use @{ CONVERT-PALETTE-GENERATE (0), CONVERT-PALETTE-WEB (2), CONVERT-PALETTE-MONO (3), CONVERT-PALETTE-CUSTOM (4) @}",
    ),
    (
      "num-cols",
      "GIMP_PDB_INT32",
...
Deprecated: Use 'gimp-drawable-edit-bucket-fill' instead.""",
  ...
  (
    ...
    (
      "fill-mode",
      "GIMP_PDB_INT32",
      "The type of fill @{ BUCKET-FILL-FG (0), BUCKET-FILL-BG (1), BUCKET-FILL-PATTERN (2) @}",
    ),
    (
      "paint-mode",
      "GIMP_PDB_INT32",
...
("plug-in-curve-bend-Iterator",
  ...
  (
    ...
    (
      "current-step",
      "GIMP_PDB_FLOAT",
      "current (for linear iterations this is the layerstack position, otherwise some value in between)",
    ),
    (
      "len-struct",
      "GIMP_PDB_INT32",
...
("file-hgt-load",
  ...
  (
    ...
    (
      "samplespacing",
      "GIMP_PDB_INT32",
      "The sample spacing of the data. Only supported values are 0, 1 and 3 (respectively auto-detect, SRTM-1 and SRTM-3 data)",
    ),
  ),
  (
    (
...
("file-dds-save",
  ...
  (
    ...
    (
      "mipmaps",
      "GIMP_PDB_INT32",
      "How to handle mipmaps (0 = No mipmaps, 1 = Generate mipmaps, 2 = Use existing mipmaps (layers)",
    ),
    (
      "savetype",
      "GIMP_PDB_INT32",
      "How to save the image (0 = selected layer, 1 = cube map, 2 = volume map, 3 = texture array",
    ),
    (
      "format",
      "GIMP_PDB_INT32",
    ...
    (
      "transparent-index",
      "GIMP_PDB_INT32",
      "Index of transparent color or -1 to disable (for indexed images only).",
    ),
    (
      "mipmap-filter",
      "GIMP_PDB_INT32",
      "Filtering to use when generating mipmaps (0 = default, 1 = nearest, 2 = box, 3 = triangle, 4 = quadratic, 5 = bspline, 6 = mitchell, 7 = lanczos, 8 = kaiser)",
    ),
    (
      "mipmap-wrap",
      "GIMP_PDB_INT32",
      "Wrap mode to use when generating mipmaps (0 = default, 1 = mirror, 2 = repeat, 3 = clamp)",
    ),
    (
      "gamma-correct",
      "GIMP_PDB_INT32",
    ...
    (
      ...
      "GIMP_PDB_INT32",
      "Preserve alpha test converage for alpha channel maps",
    ),
    (
...
("gimp-context-set-transform-recursion",
  ...
  (
    (
      "transform-recursion",
      "GIMP_PDB_INT32",
      "This parameter is ignored (transform-recursion >= 1)",
    ),
  ),
  (
  ),
...
("twain-acquire",
  ...
  (
    ...
    (
      "image-ids",
      "GIMP_PDB_INT32ARRAY",
      "Array of acquired image identifiers",
    ),
  ),
),
...
("gimp-drawable-foreground-extract",
  ...
  (
    ...
    (
      "mode",
      "GIMP_PDB_INT32",
      "The algorithm to use @{ FOREGROUND-EXTRACT-SIOX (0), FOREGROUND-EXTRACT-MATTING (1) @}",
    ),
    (
      "mask",
      "GIMP_PDB_DRAWABLE",
...
("gimp-image-get-precision",
  ...
  (
    (
      "precision",
      "GIMP_PDB_INT32",
      "The image's precision @{ PRECISION-U8-LINEAR (100), PRECISION-U8-GAMMA (150), PRECISION-U16-LINEAR (200), PRECISION-U16-GAMMA (250), PRECISION-U32-LINEAR (300), PRECISION-U32-GAMMA (350), PRECISION-HALF-LINEAR (500), PRECISION-HALF-GAMMA (550), PRECISION-FLOAT-LINEAR (600), PRECISION-FLOAT-GAMMA (650), PRECISION-DOUBLE-LINEAR (700), PRECISION-DOUBLE-GAMMA (750) @}",
    ),
  ),
),
...
("file-pat-save",
  ...
  (
    ...
    (
      "uri",
      "GIMP_PDB_STRING",
      "The URI of the file to export the image in",
    ),
    (
      "raw-uri",
      "GIMP_PDB_STRING",
...
("file-webp-save",
  ...
  (
    ...
    (
      "preset",
      "GIMP_PDB_INT32",
      "preset (Default=0, Picture=1, Photo=2, Drawing=3, Icon=4, Text=5)",
    ),
    (
      "lossless",
      "GIMP_PDB_INT32",
      "Use lossless encoding (0/1)",
    ),
    (
      "quality",
      "GIMP_PDB_FLOAT",
      "Quality of the image (0 <= quality <= 100)",
    ),
    (
      "alpha-quality",
      "GIMP_PDB_FLOAT",
      "Quality of the image's alpha channel (0 <= alpha-quality <= 100)",
    ),
    (
      "animation",
      "GIMP_PDB_INT32",
      "Use layers for animation (0/1)",
    ),
    (
      "anim-loop",
      "GIMP_PDB_INT32",
      "Loop animation infinitely (0/1)",
    ),
    (
      "minimize-size",
      "GIMP_PDB_INT32",
      "Minimize animation size (0/1)",
    ),
    (
      "kf-distance",
      "GIMP_PDB_INT32",
      "Maximum distance between key-frames (>=0)",
    ),
    (
      "exif",
      "GIMP_PDB_INT32",
      "Toggle saving exif data (0/1)",
    ),
    (
      "iptc",
      "GIMP_PDB_INT32",
      "Toggle saving iptc data (0/1)",
    ),
    (
      "xmp",
      "GIMP_PDB_INT32",
      "Toggle saving xmp data (0/1)",
    ),
    (
      "delay",
      "GIMP_PDB_INT32",
      "Delay to use when timestamps are not available or forced",
    ),
    (
      "force-delay",
      "GIMP_PDB_INT32",
...
Deprecated: Use 'gimp-drawable-edit-gradient-fill' instead.""",
  ...
  (
    ...
    (
      "blend-mode",
      "GIMP_PDB_INT32",
      "The type of blend @{ BLEND-FG-BG-RGB (0), BLEND-FG-BG-HSV (1), BLEND-FG-TRANSPARENT (2), BLEND-CUSTOM (3) @}",
    ),
    (
      "paint-mode",
      "GIMP_PDB_INT32",
...
("plug-in-sample-colorize",
  ...
  (
    ...
    (
      "gamma",
      "GIMP_PDB_FLOAT",
      "gamma adjustment factor (0.1 <= gamma <= 10) where 1.0 is linear",
    ),
    (
      "out-low",
      "GIMP_PDB_INT32",
...
("python-fu-Ham-Gimp-Stable-diffusion-img2img-inpainting",
  "",
  "Links to stable diffusion",
  "hamsolo474",
  "Licenced the same as Stable-Diffusion",
